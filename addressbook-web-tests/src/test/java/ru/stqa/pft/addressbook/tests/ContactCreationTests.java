...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    gotoAddNewPage();
    fillContactForm(new ContactData("Fname", "Mname", "Lname", "Nick", "mr", "comp", "addr", "123", "456", "789", "910", "q@qa.ru", "q@qa.com", "q@qa.net", "p.ru", "Sec addr", "1", "note"));
    submitContactForm();
    returnToHomePage();
  }
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("mobile")).sendKeys(contactData.getTelMob());
    ...
    wd.findElement(By.name("email")).sendKeys(contactData.getEmai());
